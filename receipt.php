...
if(isset($_POST['submit'])){
    ...
    // Get the change based on payment mode

    if ($mode_payment == 'Cash') {
        $change = $amount_given - $invoice_due;
    }elseif ($mode_payment == 'Till_number') {
        $change =  0;
    }else {
        $change =  0;
    }
...
$res2 = mysqli_query($conn, $sql2);	
    ...
    ";
		...
		$_SESSION['success'] = "<div class='alert alert-danger'> Payment was successiful </div>";
		header ("Location:../receipt.php");
		}
    ...
    <div class="row d-flex justify-content-center ">
        <div class="col-md-8">
            <div class="card print-container">
                <div class="d-flex flex-row p-2"> <img src="assets/images/logo.png" width="48">
                    ...
                    <!-- Medicine offered section --->
                        ...
                        <tbody>
                            ...
                            <?php 
                                                        ...
                                                        $sql ="SELECT * FROM sales WHERE invoice = '$invoice' && sales_date = '$today' ";
                                                        //create a query that fetch data from the database
                                                        $res = mysqli_query($conn,$sql);
                ...
                <div class="products p-2">
                    <table class="table table-borderless">
                        ...
                        <?php 
                                                        ...
                                                        $sql ="SELECT SUM(price) as 'price' FROM service_order  WHERE patient_no ='$invoice'  && status = '0' ";
                                                        //create a query that fetch data from the database
                                                        $res = mysqli_query($conn,$sql);
