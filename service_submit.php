       ...
       <?php require "includes/aside.php";?>
        ...
        <div class="page-wrapper">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
						 <div class="card-body">  
                          ...
                          <a href="issue_medicine.php?id=<?php echo $id;?> " class="btn btn-success">Attend</a>
								</div>
                            </div>
            ...
            <div class="container-fluid">
                 ...
                 <!--Services Offered -->
                                     <h4 class="print_container">Services offered</h4>
                                    <hr>
                                    <div class="print_container" id="inserted_diagnosis_data">
                                    <!-- Services Offered ---> 
                                    <table class="table table-bordered" id="crud_table">
                                        <tr>
                                        <th width="30%">Patient No.</th>
                                        ...
                                        <th width="5%"></th>
                                                      ...
                                                      <?php 
                                                        ...
                                                        require "includes/conn.php";				
                                                        $sql ="SELECT * FROM service_order WHERE patient_no ='$patient_no'  && status = '0'";
                                                        //create a query that fetch data from the database
                                                        $res = mysqli_query($conn,$sql);
                                                        ...
                                                        if ($res == TRUE) {
                                                            ...
                                                            if($count > 0){
                                                               ...
                                                               ?>
                                                        <tr>
                                                        <td contenteditable="true" class="customer"><?php echo $patient_no?></td>
                                                        <td contenteditable="true" class="patient_type"><?php echo $service_name?></td>
                                                        ...
                                                        <?php
                                                                    ...
                                                                    ?>
                                                                    <p class="lead text-center">No Service(s) Offered, Continue to issue Drugs</p>
                                                                    <?php
                                                                }
                                    ...
                                    <div align="right">
                                         ...
                                         <?php 
										$sql ="SELECT SUM(price) as 'price' FROM service_order  WHERE patient_no ='$patient_no' && status = '0'  && status = '0' ";
								//create a query that fetch data from the database
								$res = mysqli_query($conn,$sql);
