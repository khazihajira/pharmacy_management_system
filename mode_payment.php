       ...
       <?php require "includes/aside.php";?>
        ...
        <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-5">
                        <h4 class="page-title">Mode of Payment</h4>
            ...
            <?php 
                           ...
                           <div class="card shadow col-md-6 container px-5">
                            <div class="card-header bg-success text-white">
                               <center> <h5>Mode of Payment</h5></center>
                            
                            </div>
                                <div class="card-body">
                                <form class="form-horizontal form-material"
                             action="pos.php" enctype="multipart/form-data" method="post">

                             <div class="form-group">
                             <input type="hidden" name="patient_id" value="<?php echo $patient_id?>">
                                <input type="hidden" name="patient_no" value="<?php echo $patient_no?>">

                                    <label for="example-email" class="col-md-12"> <b>Choose Mode of Payment </b></label>
                                    <div class="col-md-12">
                                        <select class="form-control" name="mode_payment" id="">
                                            <option value="">Modes of Payment</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div  align="left" class="col-sm-12">
                                        ...
                                        <i class="mdi mdi-content-save"></i>  Continue</button>
                                    </div>
                                </div>
