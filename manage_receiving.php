                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            	...
                            	<form action="manage_receiving_inc_store.php" method="post" id="manage-receiving">
                    ...
                    <?php
						...
						<div class="row mb-3">
								<div class="col-md-4">
                                    ...
                                    <input type="text" name="midicine_name" value="<?php echo "$medicine_name";?>" class="form-control text-right" step="any"  >
									<?php
										}
