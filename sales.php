                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center ">
									...
									<div class="float-right"> <a href="sales_medicine.php?id=<?php echo $finalcode ?>" class="btn btn-success float-right"> New Sales</a>
                                </div>
                                <!-- title -->
                            </div>
                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            ...
                                            <th class="border-top-0"> Referrence NO.</th>
